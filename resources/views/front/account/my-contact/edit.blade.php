...
<div class="checkout-section spad">
    <div class="container">
        <form action="account/my-contact/edit}}" method="post" class="checkout-form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-center mb-3">
                            <a href="account/my-contact" class="border-0 btn btn-outline-danger mr-1">
